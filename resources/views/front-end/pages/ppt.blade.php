...
@section('title', 'Beranda - Modul PPT')
...
<div class="container">
    ...
    <div class="book-item">
        <img src="{{ media_url($item->cover, 'images/cover.png') }}" alt="{{ $item->nama_modul }}"
            onerror="this.onerror=null;this.src='{{ asset('images/cover.png') }}';">
        <div class="book-info">
            <h4>{{ $item->nama_modul}}</h4>
            <p>Harga: Rp. {{ number_format($item->harga, 0, ',', '.') }}</p>
            <a href="/layanan/karya-tulis/ppt-detail/{{$item->uuid}}" >Lihat Detail</a>
        </div>
    </div>
    @empty
