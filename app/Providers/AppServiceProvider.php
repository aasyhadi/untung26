...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Form::component('bsTextArea2', 'components.form.textarea2', ['label'=>'','name'=>'','default'=>'',
            'required'=>'','md_size'=>'md-8']);
        ...
        Form::component('bsNumeric', 'components.form.numerik',
            ['label'=>'','name'=>'','default'=>'',
            'required'=>'','md_size'=>'md-8']);
        Form::component('bsFile', 'components.form.file', ['label'=>'','name'=>'','default'=>'',
            'required'=>'','md_size'=>'md-8']);
        ...
        Form::component('bsReadOnly', 'components.form.textfield-readonly',
            ['label'=>'','name'=>'','default'=>'',
            'required'=>'', 'md_size'=>'md-8']);
        Form::component('bsReadOnlyTextArea', 'components.form.textarea-readonly',
            ['label'=>'','name'=>'','default'=>'',
            'required'=>'','md_size'=>'md-8']);
        Form::component('bsReadOnlyTextArea2', 'components.form.textarea2-readonly',
            ['label'=>'','name'=>'','default'=>'',
            'required'=>'','md_size'=>'md-8']);
